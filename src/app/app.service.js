...
var EntryCategory_1 = require("./models/EntryCategory");
var AppService = (function () {
    ...
    AppService.prototype.setDefaultEntryCategories = function () {
        this.entryContentCategories = [
            new EntryCategory_1.EntryCategory('Place', 'icon-places-big.png', 'Lorem ipsum dolor sit amet'),
            new EntryCategory_1.EntryCategory('Learning', 'icon-learning-big.png', 'Lorem ipsum dolor sit amet'),
            new EntryCategory_1.EntryCategory('Health', 'icon-health-big.png', 'Lorem ipsum dolor sit amet'),
            new EntryCategory_1.EntryCategory('Fitness', 'icon-fitness-big.png', 'Lorem ipsum dolor sit amet'),
            new EntryCategory_1.EntryCategory('Celebration', 'icon-celebration-big.png', 'Lorem ipsum dolor sit amet'),
            new EntryCategory_1.EntryCategory('Faves', 'icon-faves-big.png', 'Lorem ipsum dolor sit amet'),
            new EntryCategory_1.EntryCategory('Purpose', 'icon-world-big.png', 'Lorem ipsum dolor sit amet'),
            new EntryCategory_1.EntryCategory('People', 'icon-images-big.png', 'Lorem ipsum dolor sit amet'),
            new EntryCategory_1.EntryCategory('Bigs', 'logo.png', 'Lorem ipsum dolor sit amet'),
            new EntryCategory_1.EntryCategory('Other', 'icon-growth-big.png', 'Lorem ipsum dolor sit amet'),
        ];
    };
