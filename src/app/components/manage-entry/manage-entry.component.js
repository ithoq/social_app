...
var ManageEntryComponent = (function () {
    function ManageEntryComponent(auth, entryService, _loader, rightContentService, chRef, mediumToManageEntry, router) {
        ...
        this.entrycreated = new core_1.EventEmitter();
        this.entryupdated = new core_1.EventEmitter();
        /*****************/
        /* map api */
        this.showmap = false;
    ...
    __decorate([
        core_1.Output('EntryCreated')
    ], ManageEntryComponent.prototype, "entrycreated");
    __decorate([
        core_1.Output('EntryUpdated')
    ], ManageEntryComponent.prototype, "entryupdated");
