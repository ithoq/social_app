...
// RANGE SLIDER2 - SLIDER STEP BY STEP
    // =================================================================
    // Require noUiSlider
    // http://refreshless.com/nouislider/
    // =================================================================

    var rs_step2 = document.getElementById('demo-range-step2');
    var rs_step_value2 = document.getElementById('demo-range-step-val2');


    noUiSlider.create(rs_step2,{
        start   : [ 0 ],
        connect : 'lower',
        step    : 1,
        range   : {
...
format: wNumb({
    ...
    rs_step2.noUiSlider.on('update', function( values, handle ) {
        rs_step_value2.innerHTML = values[handle];
    });
