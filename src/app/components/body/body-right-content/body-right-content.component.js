...
var BodyRightContentComponent = (function () {
    ...
    BodyRightContentComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: './body-right-content.component.html',
            styleUrls: ['./body-right-content.component.css']
        })
    ], BodyRightContentComponent);
    return BodyRightContentComponent;
}());
exports.BodyRightContentComponent = BodyRightContentComponent;
//# sourceMappingURL=body-right-content.component.js.map