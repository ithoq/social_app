...
import * as import28 from '../../../../lib/components/tag-input-item/tag-input-item.component';
import * as import29 from '../tag-input-item/tag-input-item.component.ngfactory';
import * as import30 from '../../../../lib/components/tag-input-autocomplete/tag-input-autocomplete.component';
import * as import31 from '../tag-input-autocomplete/tag-input-autocomplete.component.ngfactory';
export class Wrapper_TagInputComponent {
  ...
  constructor(p0:any) {
    this._changed = false;
    this.context = new import0.TagInputComponent(p0);
...
class View_TagInputComponent_Host0 extends import2.AppView<any> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._TagInputComponent_0_3 = new Wrapper_TagInputComponent(this.injectorGet(import8.FormBuilder,this.parentIndex));
...
export class View_TagInputComponent0 extends import2.AppView<import0.TagInputComponent> {
  ...
  _text_4:any;
  _el_5:any;
  _DefaultValueAccessor_5_3:import14.Wrapper_DefaultValueAccessor;
  _NG_VALUE_ACCESSOR_5_4:any[];
  _FormControlName_5_5:import15.Wrapper_FormControlName;
  _NgControl_5_6:any;
  _NgControlStatus_5_7:import13.Wrapper_NgControlStatus;
  _text_6:any;
  _anchor_7:any;
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._NgFor_1_6 = new import11.Wrapper_NgFor(this._vc_1.vcRef,this._TemplateRef_1_5,this.parentView.injectorGet(import18.IterableDiffers,this.parentIndex),this.ref);
    ...
    this._DefaultValueAccessor_5_3 = new import14.Wrapper_DefaultValueAccessor(this.renderer,new import19.ElementRef(this._el_5));
    this._NG_VALUE_ACCESSOR_5_4 = [this._DefaultValueAccessor_5_3.context];
    this._FormControlName_5_5 = new import15.Wrapper_FormControlName(this._ControlContainer_3_4,(null as any),(null as any),this._NG_VALUE_ACCESSOR_5_4);
    this._NgControl_5_6 = this._FormControlName_5_5.context;
    this._NgControlStatus_5_7 = new import13.Wrapper_NgControlStatus(this._NgControl_5_6);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import22.FormControlName) && (5 === requestNodeIndex))) { return this._FormControlName_5_5.context; }
    if (((token === import23.NgControl) && (5 === requestNodeIndex))) { return this._NgControl_5_6; }
    if (((token === import24.NgControlStatus) && (5 === requestNodeIndex))) { return this._NgControlStatus_5_7.context; }
    ...
    if (((token === import26.FormGroupDirective) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 8)))) { return this._FormGroupDirective_3_3.context; }
    if (((token === import27.ControlContainer) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 8)))) { return this._ControlContainer_3_4; }
    if (((token === import24.NgControlStatusGroup) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 8)))) { return this._NgControlStatusGroup_3_5.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_24:any = this.context.placeholder;
    if (import3.checkBinding(throwOnChange,this._expr_24,currVal_24)) {
      this.renderer.setElementProperty(this._el_5,'placeholder',currVal_24);
...
class View_TagInputComponent1 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import28.TagInputItemComponent>;
  _TagInputItemComponent_0_3:import29.Wrapper_TagInputItemComponent;
  _text_1:any;
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this.compView_0 = new import29.View_TagInputItemComponent0(this.viewUtils,this,0,this._el_0);
    this._TagInputItemComponent_0_3 = new import29.Wrapper_TagInputItemComponent();
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import28.TagInputItemComponent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._TagInputItemComponent_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
class View_TagInputComponent2 extends import2.AppView<any> {
  ...
  _text_1:any;
  _el_2:any;
  compView_2:import2.AppView<import30.TagInputAutocompleteComponent>;
  _TagInputAutocompleteComponent_2_3:import31.Wrapper_TagInputAutocompleteComponent;
  _text_3:any;
  _text_4:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import10.ViewContainer) {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this.compView_2 = new import31.View_TagInputAutocompleteComponent0(this.viewUtils,this,2,this._el_2);
    this._TagInputAutocompleteComponent_2_3 = new import31.Wrapper_TagInputAutocompleteComponent(new import19.ElementRef(this._el_2));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import30.TagInputAutocompleteComponent) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._TagInputAutocompleteComponent_2_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
